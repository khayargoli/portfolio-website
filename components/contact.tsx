...
export default function Contact() {
  ...
  return (
    ...
    >
      ...
      <p className="text-gray-700 -mt-2 mb-2 dark:text-white/80 text-lg">
        {/*         Please contact me directly at{" "}
        <a className="underline" href="mailto:example@gmail.com">
          biswas.khayargoli@gmail.com
        </a>{" "}
        or through this form. */}
        For project inquiries, please contact me directly via <b>Upwork</b>. I handle all client work through the platform to keep things streamlined and professional.
      </p>
      <motion.div
